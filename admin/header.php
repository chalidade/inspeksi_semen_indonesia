      ...
      <div class="container">
        <div class="header-wrap">
          <div class="header-top d-flex justify-content-between align-items-center">
            <div class="logo">
              <a href="index.php"> <img src="img/logo.png" alt="" style="width:50px"> <h2 class="logo" style="float:right;margin-top:10px;margin-left:10px;"><font style="color:#ed2c2f">SEMEN</font> INDONESIA</h2></a>
            </div>
          </div>
        </div>
      </div>
